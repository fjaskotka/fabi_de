        ...
        <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-7 text-gray-300'>
            <div className='mx-auto'> 
                ...
                <div className='flex justify-between md:w-[75%] mx-auto my-6'>
                    <a href='https://www.linkedin.com/in/jaskotka/' aria-label="LinkedIn Profile"><FaLinkedin size={30}/></a>
                    <a href='https://github.com/fjaskotka' aria-label="GitHub Profile"><FaGithubSquare size={30}/></a>
                    <a href='https://www.instagram.com/fabian_jas/' aria-label="Instagram Profile"><FaInstagram size={30}/></a>
                </div>
            </div>
